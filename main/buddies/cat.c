...
static void doSleep(uint32_t t) {
  ...
  static const char* const DREAM[5] __attribute__((unused))    = { "            ", "            ", "   .-..-.   ", "  ( o.o )   ", "  `------`  " };
  ...
  buddy_print_sprite(P[SEQ[beat]], 5, 0, 0xC2A6, 0);
...
static void doCelebrate(uint32_t t) {
  ...
  buddy_print_sprite(P[SEQ[beat]], 5, Y_SHIFT[beat], 0xC2A6, 0);
...
static void doHeart(uint32_t t) {
  ...
  uint8_t beat = (t / 5) % sizeof(SEQ);
  buddy_print_sprite(P[SEQ[beat]], 5, Y_BOB[beat], 0xC2A6, 0);
