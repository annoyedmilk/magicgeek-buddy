...
static void doSleep(uint32_t t) {
  ...
  buddy_print_sprite(P[SEQ[beat]], 5, 0, 0xF810, 0);
...
static void doCelebrate(uint32_t t) {
  ...
  buddy_print_sprite(P[SEQ[beat]], 5, Y_SHIFT[beat], 0xF810, 0);
...
static void doHeart(uint32_t t) {
  ...
  uint8_t beat = (t / 5) % sizeof(SEQ);
  buddy_print_sprite(P[SEQ[beat]], 5, Y_BOB[beat], 0xF810, 0);
...
const species_t MUSHROOM_SPECIES = { "mushroom", 0xF810, { doSleep, doIdle, doBusy, doAttention, doCelebrate, doDizzy, doHeart } };
